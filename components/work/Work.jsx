            ...
            <div className={'container-fluid'}>
                ...
                <ul className={'work__wrapper'}>
                    ...
                    <li className={'work__item'}>
                        ...
                        <div>
                            <p>Сontact</p>
                            <p className={'text'}>We will contact you to clarify your project requirements.</p>
                        </div>
                    </li>
                    ...
                    <li className={'work__item'}>
                        ...
                        <div>
                            <p>Сontact</p>
                            <p className={'text'}>We will provide you with our free, non-binding application.</p>
                        </div>
                    </li>
                    ...
                    <li className={'work__item'}>
                        ...
                        <div>
                            <p>Сontact</p>
                            <p className={'text'}>We provide a team for your requirements.</p>
                        </div>
                    </li>
                    ...
                    <li className={'work__item last'}>
                        ...
                        <div>
                            <p>Сontact</p>
                            <p className={'text'}>You will get to know the team and we'll get started.</p>
                        </div>
                    </li>
