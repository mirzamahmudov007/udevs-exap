        ...
        <div className='header'>
            ...
            <div className='header__wrapper'>
                    <div className='header__left'>
                        ...
                        <h4  data-aos="fade-down" data-aos-delay="300" className="header__left__title">IT-Outsourcing Company</h4>
                        <h1 data-aos="fade-down" data-aos-delay="600" className="header__left__typing">TYPING</h1>
